...
BEGIN
    INSERT INTO evenements (
        nom, date_creation, date_debut, date_fin, personnes_maximum, lieu
    )
    VALUES (
        p_nom, NOW(), p_date_debut, p_date_fin, p_personnes_maximum, p_lieu
    );
END $$

-- ============================
-- PROCEDURE 2 : INSCRIRE PERSONNE
-- ============================
...
-- ============================
-- PROCEDURE 3 : DESINSCRIRE PERSONNE
-- ============================
...
-- ============================
-- PROCEDURE 4 : SUPPRIMER EVENEMENT (+ INSCRIPTIONS)
-- ============================
...
-- ============================
-- UTILISATEUR RESTREINT SGBDR
-- ============================

CREATE USER IF NOT EXISTS 'event_app'@'localhost' IDENTIFIED BY 'unMotDePasse';
